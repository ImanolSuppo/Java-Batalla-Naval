...
public class BattleShipGame {
    ...
    public void generateAppFleetPositions() {
        ...
        for (Position position:positions) {
            appShips.add(new Ship(position, ShipStatus.AFLOAT));
        }
        ...
        do {
            System.out.println("Donde quiere posicionar su barco?");
                ...
                if(isAvailablePosition(playerShips, position)) {
                    ...
                    System.out.println("Ya se estableció esa posición");
    ...
    public void getPlayerShot() {
        ...
        if(impactEnemyShip(appShips, position)){
            System.out.println("Impactó un barco!");
            playerEnemyFleetBoard.setShipOnBoard(position);
        }
        else {
            System.out.println("Impactó al agua!");
    ...
    public void printGameStatus() {
        ...
        System.out.println("Cantidad de barcos del jugador: " + playerShips.size());
        System.out.println("Cantidad de barcos a flote del jugador: " + barcosFlote);
    ...
    private Position getPosition() {
        ...
        do {
            ...
            if (isValidPositionInput(input)) {
                ...
                int col = Integer.parseInt(inputSeparado[0]);
                int row = Integer.parseInt(inputSeparado[1]);
